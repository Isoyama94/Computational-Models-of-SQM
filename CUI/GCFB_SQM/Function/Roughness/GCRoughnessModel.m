%
%   GCRoughnessModel: Calculation of roughness from specific loudness
%   Function [Rt,R,Rpk,dLr,ik] = GCRoughnessModel(Nd,Fs0,Setting)
...
%
function [Rt,R,Rpk,dLr,ik] = GCRoughnessModel(Npk0,Fs0,Setting)
%% Initial Setup
Fs = 1000;
...
%% Waighting function
[QR,~,~,~,~,~,gr]=GCRoughnessParameters(Setting);
