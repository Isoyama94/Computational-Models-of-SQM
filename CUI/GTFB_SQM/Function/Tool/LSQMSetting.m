...
%   ERBNnumber:                         (Default: 1.8:0.1:38.9) 
...
[Para] = GetParameter(varargin,'ERBNnumber',1.8:0.1:38.9);
Setting.ERBNnumber = Para; % Cam
[Para] = GetParameter(varargin,'Parallel','OFF'); % To be implemented in the future
