...
%       [Slp,y] = CalculationOfExcitation(GTout,fs0,E0,CF,Setting)
% 
%   Input:  GTout           Output of Auditory filterbank
%           fs0             Sampling frequency
%           E0              Constant
%   Output: Slp             Excitation pattern
%           y               Excitation Level
%
%   Created: 5 Jun. 2023
%   Copyright: (c) 2023 Unoki-Lab. JAIST
%
function [Excitation,ExcitationLevel] = CalculationOfExcitation(GTout,Fs0,E0,Setting)
[K,Sample] = size(GTout);
t = (0:Sample-1)/Fs0;
