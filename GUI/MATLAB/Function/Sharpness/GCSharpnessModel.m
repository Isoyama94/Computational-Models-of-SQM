%
%   GCSharpnessModel: Calculation of sharpness from specific loudness
%   Function [St,S] = GCSharpnessModel(Nd,N,Fs0,Setting)
...
%
function [St,S] = GCSharpnessModel(Nd,N,Fs0,Setting)
if nargin<2, help GCSharpnessModel, return; end
if nargin<3, Fs0=44100; end
if nargin<4, Setting.Figshow='OFF'; Setting.Op='Ap'; end

[QS,q] = GCSharpnessPatameters(N,Setting);
